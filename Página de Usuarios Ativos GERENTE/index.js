...
function openInNewTab(url) {
    window.location.href = "/Página de Usuario Ativo Selecionado GERENTE/index.html";
    const win = window.open('/Página de Usuario Ativo Selecionado GERENTE/index.html', '_blank');
    win.focus();
}
